 ...
 * Plugin URI:        https://chitraa.tech/
 * Description:       Add star ratings in post comment form.
 * Version:           2.0.0
 * Author:            Chitraa
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Author URI:        https://chitraa.tech/
 * Text Domain:       cfsr
 ...
 */
define('CFSR_PLUGIN_VERSION', '2.0.0');
...
add_filter('comment_text', 'cfsr_display_rating',  0, 2);
function cfsr_display_rating($comment_text, $comment)
{
